...
public class GroupAsiaClaimStaging implements Serializable {

    private static final long serialVersionUID = 2053512455;
    ...
    public GroupAsiaClaimStaging(GroupAsiaClaimStaging value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("GroupAsiaClaimStaging (");
