...
public class GaGflppf implements Serializable {

    private static final long serialVersionUID = 710741895;
    ...
    public GaGflppf(GaGflppf value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("GaGflppf (");
