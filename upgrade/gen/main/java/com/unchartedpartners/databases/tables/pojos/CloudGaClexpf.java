...
public class CloudGaClexpf implements Serializable {

    private static final long serialVersionUID = 1616866862;
    ...
    public CloudGaClexpf(CloudGaClexpf value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("CloudGaClexpf (");
