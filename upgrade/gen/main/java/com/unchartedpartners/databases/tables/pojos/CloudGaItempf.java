...
public class CloudGaItempf implements Serializable {

    private static final long serialVersionUID = 1447833086;
    ...
    public CloudGaItempf(CloudGaItempf value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("CloudGaItempf (");
