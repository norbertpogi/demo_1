...
public class GaGxhipf implements Serializable {

    private static final long serialVersionUID = 563098515;
    ...
    public GaGxhipf(GaGxhipf value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("GaGxhipf (");
