...
public class CloudGaZatrpf implements Serializable {

    private static final long serialVersionUID = 1685326124;
    ...
    public CloudGaZatrpf(CloudGaZatrpf value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("CloudGaZatrpf (");
