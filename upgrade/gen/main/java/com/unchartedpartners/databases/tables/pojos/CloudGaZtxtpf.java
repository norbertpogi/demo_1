...
public class CloudGaZtxtpf implements Serializable {

    private static final long serialVersionUID = -1063977331;
    ...
    public CloudGaZtxtpf(CloudGaZtxtpf value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("CloudGaZtxtpf (");
