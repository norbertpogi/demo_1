...
public class CloudGaGmhipf implements Serializable {

    private static final long serialVersionUID = -251086711;
    ...
    public CloudGaGmhipf(CloudGaGmhipf value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("CloudGaGmhipf (");
