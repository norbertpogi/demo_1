...
public class GroupAsiaStaging implements Serializable {

    private static final long serialVersionUID = -273302401;
    ...
    public GroupAsiaStaging(GroupAsiaStaging value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("GroupAsiaStaging (");
