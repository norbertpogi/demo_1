...
public class GaZathpf implements Serializable {

    private static final long serialVersionUID = -1354913486;
    ...
    public GaZathpf(GaZathpf value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("GaZathpf (");
