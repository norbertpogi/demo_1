...
public class GaAgntpf implements Serializable {

    private static final long serialVersionUID = -693454250;
    ...
    public GaAgntpf(GaAgntpf value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("GaAgntpf (");
