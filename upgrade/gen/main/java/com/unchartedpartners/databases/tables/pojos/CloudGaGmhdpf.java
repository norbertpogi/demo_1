...
public class CloudGaGmhdpf implements Serializable {

    private static final long serialVersionUID = 1308715781;
    ...
    public CloudGaGmhdpf(CloudGaGmhdpf value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("CloudGaGmhdpf (");
